...
import { reporterDetailFallbackTitle } from "../../../src/utils/reporterScreenCopy";
...
const styles = StyleSheet.create({
  ...
  scroll: { paddingHorizontal: 29, paddingTop: 58, paddingBottom: 30 },
